        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
          ...
          <div className="mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
              {currentBudget?.categories?.map(category => <ErrorBoundary key={category.id} fallback={<div className="p-4 border border-red-200 rounded-lg bg-red-50">
                      <p className="text-sm text-red-600">Error al cargar categoría</p>
                    </div>}>
                  <CategoryCard category={category} />
                </ErrorBoundary>) || <div className="col-span-full">
